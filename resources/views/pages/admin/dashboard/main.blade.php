            ...
            <div class="col-xl-4 mb-xl-10">
                ...
                <div class="card card-flush h-xl-100">
                    ...
                    <div class="card-header rounded bgi-no-repeat bgi-size-cover bgi-position-y-top bgi-position-x-center align-items-start h-250px"
                        style="background-image:url('admins/media/svg/shapes/top-green.png" data-theme="light">
                        <!--begin::Title-->
                        <h3 class="card-title align-items-start flex-column text-white pt-15">
                            ...
                            <div class="fs-4 text-white">
                                ...
                                <span class="position-relative d-inline-block">
                                    <a href="../../demo4/dist/pages/user-profile/projects.html"
                        ...
                        <div id="kt_sliders_widget_1_slider"
                            ...
                            <div class="card-header pt-5">
                                ...
                                <h4 class="card-title d-flex align-items-start flex-column">
                                    <span class="card-label fw-bold text-gray-800">Today’s
                                        Course</span>
                                    <span class="text-gray-400 mt-1 fw-bold fs-7">4 lessons, 3 hours
                                        45 minutes</span>
                                </h4>
                                <!--end::Title-->
                                <!--begin::Toolbar-->
                                ...
                                <div class="carousel-inner mt-n5">
                                    ...
                                    <div class="carousel-item active show">
                                        ...
                                        <div class="d-flex align-items-center mb-5">
                                            ...
                                            <div class="m-0">
                                                <!--begin::Subtitle-->
                                                <h4 class="fw-bold text-gray-800 mb-3">Ruby on Rails
                                                </h4>
                                                <!--end::Subtitle-->
                                                <!--begin::Items-->
                                        ...
                                        <!--begin::Action-->
                                        <div class="mb-1">
                                            <a href="#" class="btn btn-sm btn-light me-2">Skip
                                                This</a>
                        ...
                        <div class="m-0">
                            ...
                            <div class="position-relative fs-2x z-index-2 fw-bold text-white mb-7">
                                <span class="me-2">You have got
                                    <span class="position-relative d-inline-block text-danger">
                                        <a href="../../demo4/dist/pages/user-profile/overview.html"
                            ...
                            <div class="mb-3">
                                <a href='#' class="btn btn-danger fw-semibold me-2" data-bs-toggle="modal"
                                    ...
                                    Reward</a>
                                <a href="../../demo4/dist/apps/support-center/overview.html"
