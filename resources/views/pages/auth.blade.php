...
<head>
    <title>Sistem Informasi D3TI 2021</title>
...
<body id="kt_body" class="app-blank">
    ...
    <div class="d-flex flex-column flex-root">
        ...
        <div class="d-flex flex-column flex-lg-row flex-column-fluid">
            ...
            <div class="d-flex flex-lg-row-fluid w-lg-50 bgi-size-cover bgi-position-center order-1 order-lg-2"
                style="background-image: url({{asset('admins/media/misc/auth-bg.png')}})">
                <!--begin::Content-->
                <div class="d-flex flex-column flex-center py-7 py-lg-15 px-5 px-md-15 w-100">
                    <!--begin::Logo-->
                    <div class="mb-0 mb-lg-12">
                        <img alt="Logo" src="admins/media/logos/custom-1.png" class="h-60px h-lg-75px" />
                    </div>
                    <!--end::Logo-->
                    <!--begin::Image-->
                    <img class="d-none d-lg-block mx-auto w-275px w-md-50 w-xl-500px mb-10 mb-lg-20"
                        src="admins/media/misc/auth-screens.png" alt="" />
                    <!--end::Image-->
                    <!--begin::Title-->
    ...
    <script src="{{ asset('admins/plugins/global/plugins.bundle.js') }}"></script>
    <script src="{{ asset('admins/js/scripts.bundle.js') }}"></script>
